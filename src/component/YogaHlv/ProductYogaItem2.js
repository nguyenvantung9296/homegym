    ...
    render() {
        return (
            <div className="col-md-3 col-sm-6 col-xs-12">
                <div className="img-col img-col-Click img-col-Click-Yoga">
                    <img className="wow bounceInDown" src={this.props.image} alt="" />
                    <div className="button-click">
                        <a href={"/hlvYoga/" + this.chuyenDoiURL(this.props.name) + "." + this.props.hlvId} className="btn btn-primary">Xem Thêm</a>
                    </div>
                </div>
            </div>
        )
