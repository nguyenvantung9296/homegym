...
import './css/gymhome.css'
import girlgym from './img/girl-box.jpg'
import { Link } from 'react-router-dom';

import {WOW} from 'wowjs';
export default class GymHomePage extends Component {
  componentDidMount() {
		const wow = new WOW({
		  offset: 100,
		  mobile: false, 
  ...
  render() {
    return (
      <div>
        <div className="banner-gymhome">
          <div className="slider-text">
            <div className="container">
              <div className="row">
                <div className="col-md-12">
                  <h2 className="text-left wow fadeInLeftBig" style={{ visibility: 'visible', animationName: 'fadeInLeftBig' }}> GYMHOME</h2>
                </div>
                <div className="col-md-12">
                  <h2 className="text-right outline-green wow fadeInRightBig" style={{ visibility: 'visible', animationName: 'fadeInRightBig' }}>FITNESS</h2>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="section section section-gym-steps">
          <div className="outline-text rotate-90-left"><span>sport</span></div>
          <div className="sec-heading text-center">
            <span className="green-vl wow bounceInUp" />
            <div className="section-heading-text wow bounceInUp" data-wow-delay="0.1s">
              <h3>GymHome <br /> TRIẾT LÝ HOẠT ĐỘNG</h3>
              <p>Đối với chúng tôi, lợi ích của khách hàng chính là lợi nhuận quý báu nhất. Kết quả thực sự của khách hàng là những gì thương hiệu GymHome luôn hướng đến.”
          </p>
            </div>
          </div>
          <div className="container container-sec1">
            <div className="row mt-5">
              <div className="section1">
                <div className="img-section01 wow slideInRight">
                  <img src="https://www.elleman.vn/wp-content/uploads/2018/12/02/bai-tap-gym-elle-man-featured-image.jpg" alt="" />
                </div>
                <div className="content-sec1 wow slideInLeft">
                  <h2 className="number-01">01</h2>
                  <h2 className="gym-fitness">GYM &amp; FITNESS</h2>
                  <p>Tập luyện văn minh là một khái niệm mà GymHoe theo đuổi kiến tạo nên không gian riêng tư giúp cho hội viên đạt được trạng thái tập trung và nghiêm túc khi rèn luyện.


              </p>
                  <div className="button">
                    <a href className="general-btn ">Xem Them</a>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div className="container container-sec2">
            <div className="row mt-5">
              <div className="section2">
                <div className="img-box wow slideInLeft">
                  <img src={girlgym} alt="" />
                </div>
                <div className="content-sec2 wow slideInRight">
                  <h2 className=" number-02">02</h2>
                  <h2 className="gym-box">Boxing workout</h2>
                  <p> GymHome cam kết chương trình tập luyện được thiết kế riêng biệt, phù hợp cho mỗi khách hàng, để tất cả những giọt mồ hôi, nước mắt, tất cả thời gian
              </p>
                  <div className="">
          ...
          <div className="div-100">
            <div className="container container-fluid container-sec4">
              <div className="row mt-5">
                <div className="section1">
                  <div className="img-section01 wow slideInRight">
                    <img className="img-sec3 img-sec31" src="https://toplisthanoi.com/wp-content/uploads/2019/10/c%C6%B0a-hang-ban-do-yoga-hn3-min.jpg" alt="" />
                    <img className="img-sec3 img-sec32" src="https://s3.amazonaws.com/onoffblog/wp-content/uploads/2018/11/20114947/quan-legging-the-thao.jpg" alt="" />
                    <a className="success-pre-arr slick-arrow" style={{ display: 'block' }} tabIndex={0}><svg xmlns="http://www.w3.org/2000/svg" width={20} height={18} viewBox="0 0 19.813 38.2" stroke="#000000"><path className="cls-1" d="M284.5,10050.4l0.707,0.7-19.092,19.1-0.707-.7Zm-18.385,18.4,19.092,19.1-0.707.7-19.092-19.1Z" transform="translate(-265.406 -10050.4)" /></svg></a>
                    <a className="success-next-arr slick-arrow" style={{ display: 'block' }} tabIndex={0}><svg xmlns="http://www.w3.org/2000/svg" width={20} height={18} viewBox="0 0 20 38" stroke="#000000"><path d="M1635.73,10050l-0.72.7,19.27,19,0.72-.7Zm18.55,18.3-19.27,19,0.72,0.7,19.27-19Z" transform="translate(-1635 -10050)" /></svg></a>
                  </div>
                  <div className="content-sec1 wow slideInLeft">
                    <h2 className="number-01">03</h2>
                    <h2 className="gym-fitness gym-fitnes3">YOGA GYMHOME</h2>
                    <p className="content-sec3p">Tại Yoga Home, Coach vừa là thầy, vừa là người bạn đồng hành trên hành trình biến đổi bản thân; là người dẫn dắt bạn đến với thành công, trao kiến thức khi bạn còn đang mông lung
                </p>
                    <div className="">
